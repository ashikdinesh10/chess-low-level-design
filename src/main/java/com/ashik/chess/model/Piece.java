...
import static com.ashik.chess.helpers.ListHelpers.removeDuplicates;

import java.util.ArrayList;
import java.util.List;

import com.ashik.chess.conditions.PieceCellOccupyBlocker;
import com.ashik.chess.exceptions.InvalidMoveException;
import com.ashik.chess.moves.PossibleMovesProvider;
...
public class Piece {
    ...
    /**
     * A piece can have multiple move providers
     * 
     * @param color
     * @param movesProviders
     * @param pieceType
     */
